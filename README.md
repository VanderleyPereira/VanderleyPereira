...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Time+New+Roman&color=cyan&size=25&center=true&vCenter=true&width=600&height=100&lines=Amante+de+Tecnologia;Desenvolvedor+Full-Stack;Cursando+Ciência+da+Computação;Sempre+aprendendo+algo+novo!">
</p>
...
- Tecnologias atuais: **Angular**, **C#**, **React**, **Python**, **PHP**
- Experiência com análise de dados e **Power BI**
- Gerenciamento de bancos de dados (MySQL, SQL Server, MongoDB)
- Experiência com **Scriptcase**, automações e ferramentas web
